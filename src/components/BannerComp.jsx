...
export default function BannerComp() {
  return (
    <Banner className="px-10 mb-6 mt-2">
      <div className=" rounded-2xl flex w-full flex-col justify-between border-b border-gray-200 bg-gray-50 p-4 md:flex-row dark:border-gray-600 dark:bg-gray-700">
